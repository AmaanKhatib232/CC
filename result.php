...
if(isset($_POST['submit']))
{
	...
	$standerd=$_POST['std'];//post will fetch the std and roll number entered by student 
	$rollno =$_POST['rollno'];
	$sql="SELECT * FROM `student_data` WHERE `u_class`='$standerd' AND `u_rollno`='$rollno'";//sql query for fetching info from database 
